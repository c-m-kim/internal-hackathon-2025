        ...
        <div className="grid gap-2 mb-6 p-4 bg-gray-50 rounded border border-gray-100">
          ...
          <div className="flex gap-2 flex-col md:flex-row">
            <input 
              ...
              className="border p-2 rounded flex-grow bg-gray-700 text-white border-gray-600 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
              value={newProject.name || ''}
              onChange={e => setNewProject({...newProject, name: e.target.value})}
            />
            <input 
              placeholder="Table #" 
              className="border p-2 rounded w-full md:w-24 bg-gray-700 text-white border-gray-600 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
              value={newProject.table || ''}
              onChange={e => setNewProject({...newProject, table: e.target.value})}
            />
             <input 
              placeholder="Category" 
              className="border p-2 rounded w-full md:w-32 bg-gray-700 text-white border-gray-600 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
