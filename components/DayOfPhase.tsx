  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div>
        ...
        <input 
          type="number" 
          className="w-full p-2 border rounded bg-gray-700 text-white border-gray-600 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
      ...
      <div>
        ...
        <textarea 
          className="w-full p-2 border rounded h-24 bg-gray-700 text-white border-gray-600 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
