      ...
      <div className="bg-white min-h-screen pb-20">
        ...
        <div className="p-4 space-y-6">
            ...
            <div>
                ...
                <textarea 
                    className="w-full border p-3 rounded h-24 bg-gray-700 text-white border-gray-600 placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" 
    ...
    <div className="pb-20">
      <div className="bg-indigo-900 text-white p-6 rounded-b-xl shadow-lg mb-6">
         ...
         <div className="relative">
             ...
             <input 
                className="w-full p-2 pl-10 rounded bg-indigo-800 text-white placeholder-indigo-300 border-none focus:ring-1 focus:ring-indigo-400" 
